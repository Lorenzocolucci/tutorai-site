      ...
      <section id="curricula" className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="text-center mt-16">
            ...
            {/* Desktop Version - Enhanced Design */}
            <div className="hidden lg:block mt-12">
              <div className="grid grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div className="space-y-4">
                  <div className="text-center mb-6">
                    ...
                    <h4 className="text-lg font-semibold text-gray-800">{t('home.curricula.subjectCategories.mathematics')}</h4>
                  </div>
                  <div className="space-y-3">
                                         {[
                       t('home.curricula.subjectNames.mathematics'),
                       t('home.curricula.subjectNames.physics'),
                       t('home.curricula.subjectNames.chemistry'),
                       t('home.curricula.subjectNames.biology'),
                       t('home.curricula.subjectNames.sciences')
                     ].map((subject) => (
                      <div key={subject} className="group cursor-pointer">
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200 hover:border-blue-300 rounded-xl p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-md">
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-gray-700 group-hover:text-blue-700 transition-colors">{subject}</span>
                            <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div className="space-y-4">
                  <div className="text-center mb-6">
                    ...
                    <h4 className="text-lg font-semibold text-gray-800">{t('home.curricula.subjectCategories.humanities')}</h4>
                  </div>
                  <div className="space-y-3">
                    {[
                      t('home.curricula.subjectNames.italian'),
                      t('home.curricula.subjectNames.latin'),
                      t('home.curricula.subjectNames.history'),
                      t('home.curricula.subjectNames.philosophy'),
                      t('home.curricula.subjectNames.english')
                    ].map((subject) => (
                      <div key={subject} className="group cursor-pointer">
                        <div className="bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 border border-purple-200 hover:border-purple-300 rounded-xl p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-md">
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-gray-700 group-hover:text-purple-700 transition-colors">{subject}</span>
                            <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                              <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                              </svg>
                            </div>
                ...
                <div className="space-y-4">
                  <div className="text-center mb-6">
                    ...
                    <h4 className="text-lg font-semibold text-gray-800">{t('home.curricula.subjectCategories.technical')}</h4>
                  </div>
                  <div className="space-y-3">
                    {[
                      t('home.curricula.subjectNames.computerScience'),
                      t('home.curricula.subjectNames.economics'),
                      t('home.curricula.subjectNames.law'),
                      t('home.curricula.subjectNames.art'),
                      t('home.curricula.subjectNames.music')
                    ].map((subject) => (
                      <div key={subject} className="group cursor-pointer">
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 border border-green-200 hover:border-green-300 rounded-xl p-4 transition-all duration-300 transform hover:scale-105 hover:shadow-md">
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-gray-700 group-hover:text-green-700 transition-colors">{subject}</span>
              ...
              <div className="mt-8 text-center">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-50 to-amber-50 hover:from-orange-100 hover:to-amber-100 border-2 border-orange-200 hover:border-orange-300 rounded-2xl p-6 transition-all duration-300 transform hover:scale-105 hover:shadow-lg cursor-pointer">
                  ...
                  <div className="text-left">
                    <h4 className="text-lg font-bold text-gray-800">{t('home.curricula.subjectCategories.manyMore')}</h4>
                    <p className="text-sm text-gray-600 mt-1">{t('home.curricula.subjectCategories.manyMoreDescription')}</p>
                  </div>
                  <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
