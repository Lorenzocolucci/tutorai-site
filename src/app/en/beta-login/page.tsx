...
const BetaLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate error for demo (wrong code)
    if (formData.code !== 'BETA2024') {
      setError('Invalid access code. Check your email or request a new code.');
      setIsSubmitting(false);
      return;
    }
    
    // Success - redirect to beta dashboard
    router.push('/en/beta-dashboard');
  };
    ...
    <div className="min-h-screen-safe bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center">
      <div className="perspective-container">
        ...
        <div className="text-center mb-8">
          <Link href="/en" className="text-2xl font-bold text-text-primary flex items-center justify-center gap-2 mb-4">
          ...
          <p className="text-text-secondary">
            Enter your access code to join the beta platform
          </p>
        </div>
