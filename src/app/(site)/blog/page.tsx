...
import { getAllBlogPosts, categories } from '@/lib/blog-posts';

const BlogPage = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [activeCategory, setActiveCategory] = useState('tutti');

  // Ottieni tutti i post dal sistema centralizzato
      ...
      <div className="bg-white">
        <div className="container mx-auto px-6 py-24">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary via-purple-600 to-blue-600 bg-clip-text text-transparent mb-6 animate-fade-in-up">
              Blog TutorAI
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed animate-fade-in-up animation-delay-200">
              Scopri le ultime intuizioni su educazione, intelligenza artificiale e apprendimento personalizzato.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Trova il Tuo Articolo Perfetto</h2>
            ...
            <div className="flex flex-wrap gap-3">
              {categories.map((category) => (
                ...
                >
                  {category === 'tutti' ? 'Tutti gli Articoli' : category}
                </button>
              ))}
            </div>

            <div className="mt-4 text-sm text-gray-600">
              Mostrando {filteredPosts.length} articol{filteredPosts.length !== 1 ? 'i' : 'o'}
            </div>
          </div>
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Prova a modificare i termini di ricerca o il filtro categoria.</p>
              <button 
                onClick={() => {setSearchTerm(''); setActiveCategory('tutti');}}
          ...
          <div className="mt-16 bg-gradient-to-r from-primary to-purple-600 text-white rounded-2xl p-8 text-center">
            ...
            <p className="text-lg mb-6 opacity-90">
              Unisciti a migliaia di studenti che hanno rivoluzionato la loro esperienza di studio con TutorAI.
            </p>
            <Link
              href="/beta-access"
