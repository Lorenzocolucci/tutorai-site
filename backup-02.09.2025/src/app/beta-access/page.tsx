...
const BetaAccessPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
                        // Creiamo un riferimento a un nuovo documento nella collezione 'form_submissions'.
                  // Usiamo l'email come ID del documento per evitare richieste duplicate.
                  const requestDocRef = doc(db, 'form_submissions', formData.email);

                        // Salviamo i dati del form nel documento nel formato corretto per form_submissions.
                  await setDoc(requestDocRef, {
                    data: {
                      firstName: formData.nome,
                      lastName: formData.cognome,
                      email: formData.email,
                      userType: formData.userType, // Ora usa il valore dal form
                    ...
                    pageUrl: 'https://mytutorai.app/beta-access',
                    referrer: '',
                  ...
                  const emailResponse = await fetch('/api/send-beta-email', {
                    method: 'POST',
                  ...
                  if (!emailResponse.ok) {
                    console.error("Errore nell'invio dell'email di benvenuto");
                  }
