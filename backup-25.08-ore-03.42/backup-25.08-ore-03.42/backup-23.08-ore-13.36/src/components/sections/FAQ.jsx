...
const faqData = [
  ...
  {
    question: "Quali materie e curricula supportate?",
    answer: "Supportiamo tutte le principali materie (STEM e umanistiche) per i sistemi scolastici Italiano (MIUR), IB, IGCSE/UK, Americano, Francese e Tedesco. La nostra conoscenza è in continua espansione."
  },
  {
    question: "I dati di mio figlio sono al sicuro?",
    answer: "Assolutamente. La privacy e la sicurezza sono la nostra massima priorità. Tutti i dati sono crittografati e anonimizzati. Rispettiamo pienamente le normative GDPR e non condividiamo mai i dati personali con terze parti."
  }
];
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-text-secondary max-w-3xl mx-auto">
            Tutto quello che devi sapere prima di iniziare la rivoluzione del tuo studio, senza filtri.
          </p>
        </div>
