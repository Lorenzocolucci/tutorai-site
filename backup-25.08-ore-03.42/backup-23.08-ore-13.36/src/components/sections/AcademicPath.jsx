...
const AcademicPath = () => {
    ...
    return (
        <>
            <section ref={pathRef} id="academic-path" className="py-12 md:py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
                    ...
                    <div className="relative h-[1200px] md:h-[600px]">
                        ...
                        {pathData.map((item, index) => (
                            ...
                            >
                                <button onClick={() => setSelectedMilestone(item)} className="w-full text-left bg-white rounded-2xl shadow-xl p-4 md:p-6 border-t-4 border-primary/50 hover:shadow-2xl hover:-translate-y-1 transition-all">
