...
const Curricula = () => {
  ...
  return (
    <>
      <section id="curricula" className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
            {curriculaData.map((curriculum) => (
              <div 
                key={curriculum.name} 
                className="bg-surface p-4 md:p-6 rounded-2xl text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border border-transparent hover:border-primary cursor-pointer"
          ...
          <div className="text-center mt-16">
            ...
            <div className="mt-6 flex flex-wrap justify-center items-center gap-3">
                {subjectsData.map((subject) => (
                  <span key={subject} className="bg-primary/10 text-primary font-semibold px-4 py-2 rounded-full">
                    {subject}
                  </span>
                ))}
            </div>
