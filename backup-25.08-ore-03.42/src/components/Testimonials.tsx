        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="perspective-container">
            <div className="card-oblique glowing-border card text-center reveal">
              <div className="text-4xl font-extrabold"><span ref={kpi1}>0</span>%</div>
              <div className="text-slate-600">migliorano i voti</div>
            </div>
          </div>
          <div className="perspective-container">
            <div className="card-oblique glowing-border card text-center reveal">
              <div className="text-4xl font-extrabold"><span ref={kpi2}>0</span>%</div>
              <div className="text-slate-600">riduzione del tempo</div>
            </div>
          </div>
          <div className="perspective-container">
            <div className="card-oblique glowing-border card text-center reveal">
              <div className="text-4xl font-extrabold"><span ref={kpi3}>0</span>%</div>
              <div className="text-slate-600">più motivazione</div>
            </div>
          </div>
          <div className="perspective-container">
            <div className="card-oblique glowing-border card text-center reveal">
              <div className="text-4xl font-extrabold"><span ref={kpi4}>0</span>%</div>
              <div className="text-slate-600">risparmio medio</div>
            </div>
          </div>
        </div>
      </div>
