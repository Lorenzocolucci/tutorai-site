...
const AboutUs = () => {
    ...
    return (
        <>
            <section id="about-us" className="py-16 bg-slate-900 text-white">
                <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="perspective-container">
                          <div onClick={() => handleOpenModal('experience')} className="card-oblique glowing-border-follow bg-slate-800 p-8 rounded-2xl text-center flex flex-col items-center cursor-pointer transform transition-all duration-300 hover:-translate-y-2 hover:bg-slate-700 border border-slate-600">
                              <h3 className="text-2xl font-bold text-blue-400">Esperienza</h3>
                              <p className="mt-4 text-gray-300 flex-grow">Nati sul campo, tra i banchi di scuola. Non siamo solo tecnologi, ma prima di tutto educatori...</p>
                              <span className="mt-6 font-semibold text-blue-400">Scopri di più →</span>
                          </div>
                        </div>
                         {/* Card Tecnologia */}
                        <div className="perspective-container">
                          <div onClick={() => handleOpenModal('technology')} className="card-oblique glowing-border-follow bg-slate-800 p-8 rounded-2xl text-center flex flex-col items-center cursor-pointer transform transition-all duration-300 hover:-translate-y-2 hover:bg-slate-700 border border-slate-600">
                              <h3 className="text-2xl font-bold text-blue-400">Tecnologia</h3>
                              <p className="mt-4 text-gray-300 flex-grow">Un'IA con un cuore umano, addestrata su psicologia cognitiva e neuroscienze...</p>
                              <span className="mt-6 font-semibold text-blue-400">Scopri di più →</span>
                          </div>
                        </div>
                         {/* Card Visione */}
                        <div className="perspective-container">
                          <div onClick={() => handleOpenModal('vision')} className="card-oblique glowing-border-follow bg-slate-800 p-8 rounded-2xl text-center flex flex-col items-center cursor-pointer transform transition-all duration-300 hover:-translate-y-2 hover:bg-slate-700 border border-slate-600">
                              <h3 className="text-2xl font-bold text-blue-400">Visione</h3>
                              <p className="mt-4 text-gray-300 flex-grow">Un'educazione d'elite per tutti. Democratizzare l'accesso a un supporto di altissima qualità...</p>
                              <span className="mt-6 font-semibold text-blue-400">Scopri di più →</span>
                          </div>
                        </div>
                    </div>
