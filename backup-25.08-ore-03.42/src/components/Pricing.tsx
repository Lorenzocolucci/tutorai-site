      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="perspective-container">
            <div className="card-oblique glowing-border card text-center relative">
            <div className="mb-6">
          ...
          <div className="perspective-container">
            <div className="card-oblique glowing-border-pulse card text-center relative border-2 border-indigo-600 bg-indigo-50">
