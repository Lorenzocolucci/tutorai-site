    ...
    generale: [
      {
        ...
        answer: "TutorAI è un tutor intelligente basato sull'intelligenza artificiale che si adatta al tuo stile di apprendimento personale. A differenza dei tutor tradizionali, TutorAI analizza [...]"
      },
      {
        question: "Come funziona TutorAI?",
        answer: "TutorAI utilizza algoritmi avanzati di machine learning per analizzare il tuo stile cognitivo, le tue lacune e i tuoi punti di forza. Basandosi su questi dati, crea un percorso di[...]"
      },
      {
        question: "TutorAI sostituisce i tutor umani?",
        answer: "TutorAI non sostituisce completamente i tutor umani, ma offre un supporto complementare e spesso più efficace. È disponibile 24/7, non si stanca mai e può analizzare migliaia d[...]"
      }
    ],
    tecnico: [
      {
        question: "Quali dispositivi supporta TutorAI?",
        answer: "TutorAI funziona su tutti i dispositivi: computer desktop, laptop, tablet e smartphone. L'interfaccia si adatta automaticamente alle dimensioni dello schermo per offrire la miglio[...]"
      },
      {
        question: "Ho bisogno di una connessione internet?",
        answer: "Sì, TutorAI richiede una connessione internet per funzionare. Questo permette al sistema di aggiornarsi continuamente con nuovi contenuti e di sincronizzare i tuoi progressi su t[...]"
      },
      {
        question: "I miei dati sono sicuri?",
        answer: "Assolutamente sì. Tutti i dati sono crittografati e protetti secondo gli standard GDPR. Non condividiamo mai le tue informazioni personali con terze parti senza il tuo consenso e[...]"
      }
    ],
    pricing: [
      {
        question: "Quanto costa TutorAI?",
        answer: "TutorAI offre diversi piani di abbonamento. Durante la fase Beta, offriamo 1 mese gratuito con 1000 crediti. Dopo la Beta, i prezzi partiranno da €19.99/mese per il piano base, [...]"
      },
      {
    ...
    curricula: [
      {
        ...
        answer: "TutorAI supporta tutti i principali sistemi scolastici: Sistema Italiano (MIUR), IGCSE/UK System, International Baccalaureate (IB), American K-12, AEFE (Francese) e Gymnasium (Ted[...]"
      },
      {
        question: "E se cambio scuola o sistema?",
        answer: "TutorAI si adatta automaticamente quando cambi sistema scolastico. Basta aggiornare le tue preferenze e il sistema ricreerà il tuo percorso di apprendimento per il nuovo curricul[...]"
      },
      {
